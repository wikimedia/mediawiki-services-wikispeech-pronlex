...
// Use the Validator.Validate (or ValidateEntry) function to have one or more entries validated. Implemented validators are found in sub package validation/validators.
//
package validation
