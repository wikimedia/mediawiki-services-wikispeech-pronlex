...
func testURLsWithContent(port string) (int, int, error) {
 ...
 { "id": 9, "lexRef": { "dbRef": "speechoid_lexserver_testdb", "lexName": "sv" }, "strn": "dom", "language": "sv", "partOfSpeech": "NN", "morphology": "UTR IND SIN", "wordParts": "dom", "lemma": { "id": 5, "strn": "dom"}, "transcriptions": [ { "id": 12, "entryId": 9, "strn": "\" d o: m", "language": "sv" } ], "status": { "id": 11, "name": "demo", "source": "auto", "timestamp": "2017-11-14T11:56:07Z", "current": true }, "preferred": false, "tag": "building"}]`,
	...
	jsonListTestsMustContain := map[string][]string{
		"/admin/list_dbs": {"speechoid_lexserver_testdb"},
