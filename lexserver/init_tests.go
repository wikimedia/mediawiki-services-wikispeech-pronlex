...
func testURLsWithContent(port string) (int, int, error) {
 ...
 { "id": 9, "lexRef": { "DBRef": "lexserver_testdb", "LexName": "sv" }, "strn": "dom", "language": "sv", "partOfSpeech": "NN", "morphology": "UTR IND SIN", "wordParts": "dom", "lemma": { "id": 5, "strn": "dom", "reading": "", "paradigm": "" },"tag":"", "transcriptions": [ { "id": 12, "entryId": 9, "strn": "\" d o: m", "language": "sv", "sources": [] } ], "status": { "id": 9, "name": "demo", "source": "auto", "timestamp": "2017-08-18T10:04:44Z", "current": true }, "entryValidations": [], "preferred": false }]`,
	}
