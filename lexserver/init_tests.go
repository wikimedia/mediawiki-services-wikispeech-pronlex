...
func testURLsWithContent(port string) (int, int, error) {
	...
	lookupTests := map[string]string{
		"/lexicon/lookup?lexicons=wikispeech_lexserver_testdb:sv&wordlike=h%C3%A4st__": `[{"id":6,"lexRef":{"dbRef":"wikispeech_lexserver_testdb","lexName":"sv"},"strn":"hästar","language":"sv","partOfSpeech":"NN","morphology":"NEU IND PLU","wordParts":"hästar","lemma":{"id":4,"strn":"häst"},"transcriptions":[{"id":9,"entryId":6,"strn":"\" h E . s t a r","language":"sv"}],"status":{"id":6,"name":"demo","source":"auto","timestamp":"2020-05-25T12:44:47Z","current":true},"entryValidations":[],"preferred":false,"tag":"","comments":[]},{"id":7,"lexRef":{"dbRef":"wikispeech_lexserver_testdb","lexName":"sv"},"strn":"hästar","language":"sv","partOfSpeech":"NN","morphology":"NEU IND PLU","wordParts":"hästar","lemma":{"id":4,"strn":"häst"},"transcriptions":[{"id":10,"entryId":7,"strn":"\" h { . s t a r","language":"sv"}],"status":{"id":7,"name":"demo","source":"auto","timestamp":"2020-05-25T12:44:47Z","current":true},"entryValidations":[],"preferred":false,"tag":"","comments":[]}]`,

		"/lexicon/lookup?lexicons=wikispeech_lexserver_testdb:sv&wordpartsregexp=h%C3%A4st": `[{"id":5,"lexRef":{"dbRef":"wikispeech_lexserver_testdb","lexName":"sv"},"strn":"häst","language":"sv","partOfSpeech":"NN","morphology":"NEU IND SIN","wordParts":"häst","lemma":{"id":4,"strn":"häst"},"transcriptions":[{"id":8,"entryId":5,"strn":"\" h E s t","language":"sv"}],"status":{"id":5,"name":"demo","source":"auto","timestamp":"2020-05-25T12:46:16Z","current":true},"entryValidations":[],"preferred":false,"tag":"","comments":[]},{"id":6,"lexRef":{"dbRef":"wikispeech_lexserver_testdb","lexName":"sv"},"strn":"hästar","language":"sv","partOfSpeech":"NN","morphology":"NEU IND PLU","wordParts":"hästar","lemma":{"id":4,"strn":"häst"},"transcriptions":[{"id":9,"entryId":6,"strn":"\" h E . s t a r","language":"sv"}],"status":{"id":6,"name":"demo","source":"auto","timestamp":"2020-05-25T12:46:16Z","current":true},"entryValidations":[],"preferred":false,"tag":"","comments":[]},{"id":7,"lexRef":{"dbRef":"wikispeech_lexserver_testdb","lexName":"sv"},"strn":"hästar","language":"sv","partOfSpeech":"NN","morphology":"NEU IND PLU","wordParts":"hästar","lemma":{"id":4,"strn":"häst"},"transcriptions":[{"id":10,"entryId":7,"strn":"\" h { . s t a r","language":"sv"}],"status":{"id":7,"name":"demo","source":"auto","timestamp":"2020-05-25T12:46:16Z","current":true},"entryValidations":[],"preferred":false,"tag":"","comments":[]}]`,

		"/lexicon/lookup?lemmas=kex&lexicons=wikispeech_lexserver_testdb:sv": `[{"id":1,"lexRef":{"dbRef":"wikispeech_lexserver_testdb","lexName":"sv"},"strn":"kex","language":"sv","partOfSpeech":"NN","morphology":"NEU IND SIN","wordParts":"kex","lemma":{"id":1,"strn":"kex"},"transcriptions":[{"id":1,"entryId":1,"strn":"\" k e k s","language":"sv"},{"id":2,"entryId":1,"strn":"\" C e k s","language":"sv"}],"status":{"id":1,"name":"demo","source":"auto","timestamp":"2020-05-25T12:46:40Z","current":true},"entryValidations":[],"preferred":false,"tag":"","comments":[]},{"id":2,"lexRef":{"dbRef":"wikispeech_lexserver_testdb","lexName":"sv"},"strn":"kexet","language":"sv","partOfSpeech":"NN","morphology":"NEU DEF SIN","wordParts":"kexet","lemma":{"id":1,"strn":"kex"},"transcriptions":[{"id":3,"entryId":2,"strn":"\" k e k . s @ t","language":"sv"},{"id":4,"entryId":2,"strn":"\" C e k . s @ t","language":"sv"}],"status":{"id":2,"name":"demo","source":"auto","timestamp":"2020-05-25T12:46:40Z","current":true},"entryValidations":[],"preferred":false,"tag":"","comments":[]}]`,

		"/lexicon/lookup?lexicons=wikispeech_lexserver_testdb:sv&words=dom&transcriptionlike=%25o:%25&pp=yes": `[   {     "id": 9,     "lexRef": {       "dbRef": "wikispeech_lexserver_testdb",       "lexName": "sv"     },     "strn": "dom",     "language": "sv",     "partOfSpeech": "NN",     "morphology": "UTR IND SIN",     "wordParts": "dom",     "lemma": {       "id": 5,       "strn": "dom"     },     "transcriptions": [       {         "id": 12,         "entryId": 9,         "strn": "\" d o: m",         "language": "sv"       }     ],     "status": {       "id": 11,       "name": "demo",       "source": "auto",       "timestamp": "2020-05-25T12:47:04Z",       "current": true     },     "entryValidations": [],     "preferred": false,     "tag": "building",     "comments": []   } ]`}
	...
	jsonListTestsMustContain := map[string][]string{
		"/admin/list_dbs": {"wikispeech_lexserver_testdb"},
