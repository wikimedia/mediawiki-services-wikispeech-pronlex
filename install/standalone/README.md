...
1. Install the pronlex server
   ...
   $ sh [install.sh](https://raw.githubusercontent.com/stts-se/pronlex/master/install/standalone/install.sh) <APPDIR>
...
2. Import lexicon files (optional)
   ...
   $ sh [import.sh](https://raw.githubusercontent.com/stts-se/pronlex/master/install/standalone/import.sh) <APPDIR>
